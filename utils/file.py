...
class Snmp:
    def __init__(self):
        ...
        self.analyzer_channel_status = "{0}/snmp/analyzer/channel_status".format(self.currentPath)
        self.analyzer_channel_name = "{0}/snmp/analyzer/channel_name".format(self.currentPath)
